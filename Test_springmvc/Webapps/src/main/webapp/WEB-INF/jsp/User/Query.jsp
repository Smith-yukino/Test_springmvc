...
<table border="1" cellpadding="10" cellspacing="0">
    ...
    <c:forEach items="${requestScope.page.list}" var="list">
        <tr>
            ...
            <td><c:if test="${list.path != null}"><img width="75" height="75" src="<%=request.getContextPath()%>/ResponseEntityHead?path=<%=java.net.URLEncoder.encode((String) request.getAttribute("path"))%>"/></c:if></td>
            <td>${list.name}</td>
            <td>${list.password}</td>
